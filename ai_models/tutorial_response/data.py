...
ROBUST_SCENARIOS: list[dict[str, Any]] = [
    {
        ...
        "stages": ["orient"],
        "questions": [
            "今日は、かわいい・便利・人に見せたい・研究っぽい、どれに近いですか？",
            "作りたいものがまだ決まっていなくても大丈夫です。今の気分を一言で教えてください。",
            "部屋に置きたい、友達に見せたい、生活を助けたい、どれが近いですか？",
            "Lチカの次に進むなら、どんな雰囲気の作品がよさそうですか？",
        ],
        "answers": {
            "confirmed": [
                "かわいいものが作りたいです",
    ...
    },
    {
        ...
        "questions": [
            "今回の上限予算は何円くらいにしますか？",
            "0円で試す、1000円以内、3000円以内、5000円以内ならどれが近いですか？",
            "追加で買える部品代は、だいたいいくらまでにしたいですか？",
            "安く試す案と作品性重視の案なら、どちらに寄せたいですか？",
        ],
        "answers": {
            "confirmed": [
                "5000円以内がいいです",
                ...
                "できれば手元の部品だけでやりたいです",
                "3000円以内なら買えます",
                "多少かかっても作品っぽさを重視したいです",
            ],
            "unknown": [
                "相場が分からないです",
                "いくらかかるか分からないので決められません",
                "安い方がいいけど必要なら買います",
            ],
            "problem_report": [
                "部品代が読めなくて買うのが怖いです",
                "安く見積もられて後から足りないのが困ります",
            ],
        },
    },
    {
