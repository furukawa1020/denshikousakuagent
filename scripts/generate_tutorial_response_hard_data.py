...
SCENARIOS = [
    ...
    },
    {
        ...
        "answers": ["yes, it goes through the resistor", "抵抗を通っています", "LED long leg -> resistor -> GPIO", "220 ohm is in series"],
        "targets": [
            ("抵抗は入っています", "抵抗が直列に入っていれば、LEDをGPIOへ直結していないので安全側です。次はピン番号とコードを合わせます。", "コードとシリアル確認へ進みます。"),
            ("LED保護はできています", "長い足が抵抗を通ってGPIO側なら、LEDの向きと保護は一旦クリアです。", "確認コードを書き込んでLEDだけで点灯確認します。"),
        ],
        "symptom": "none",
    },
    {
